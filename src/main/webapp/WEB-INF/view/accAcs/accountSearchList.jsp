                ...
                <li class="contents">
                    ...
                    <div class="content">
                        ...
                        <a href="" class="btnType blue" id="btnSearch" name="btn"
                           style="margin-left: 30px;"><span>검  색</span></a>
            ...
            <dd class="content">
                ...
                <table class="row">
                    ...
                    <tr>
                        ...
                        <th scope="row">구분</th>
                        <td><input type="text" class="inputTxt p100 acv" name="inoutNm" id="inoutNm"
                                   style="border:none"/></td>
                        <th scope="row">담당자</th>
                        <td><input type="text" class="inputTxt p100 acv" name="person" id="person" style="border:none"/>
                        </td>
                        <th scope="row">일자</th>
                        <td><input type="text" class="inputTxt p100 acv" name="date" id="date" style="border:none"/>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">거래처</th>
                        <td><input type="text" class="inputTxt p100 acv" name="clientNm" id="clientNm"
                                   style="border:none"/></td>
                        <th>주문번호</th>
                    ...
                    <tr>
                        <td colspan="4"><input type="text" class="inputTxt p100 acv" name="Suname1" id="Suname1"
                                               style="border:none"/></td>
                        <td colspan="2"><input type="text" class="inputTxt p100 acv" name="E1" id="E1"
                                               style="border:none"/></td>
                        <td colspan="2"><input type="text" class="inputTxt p100 acv" name="R1" id="R1"
                                               style="border:none"/></td>
                    </tr>
                    <tr>
                        <td colspan="4"><input type="text" class="inputTxt p100 acv" name="Suname2" id="Suname2"
                                               style="border:none"/></td>
                        <td colspan="2"><input type="text" class="inputTxt p100 acv" name="E2" id="E2"
                                               style="border:none"/></td>
                        <td colspan="2"><input type="text" class="inputTxt p100 acv" name="R2" id="R2"
                                               style="border:none"/></td>
                    </tr>
                    <tr>
                        <td colspan="4"><input type="text" class="inputTxt p100 acv" name="Suname3" id="Suname3"
                                               style="border:none"/></td>
                        <td colspan="2"><input type="text" class="inputTxt p100 acv" name="E3" id="E3"
                                               style="border:none"/></td>
                        <td colspan="2"><input type="text" class="inputTxt p100 acv" name="R3" id="R3"
                                               style="border:none"/></td>
                    </tr>
                    <tr>
                        <td colspan="4"><input type="text" class="inputTxt p100 acv" name="Suname4" id="Suname4"
                                               style="border:none"/></td>
                        <td colspan="2"><input type="text" class="inputTxt p100 acv" name="E4" id="E4"
                                               style="border:none"/></td>
                        <td colspan="2"><input type="text" class="inputTxt p100 acv" name="R4" id="R4"
                                               style="border:none"/></td>
                    </tr>
                    <tr>
                        <th scope="row" colspan="4">합계</th>
                        <th colspan="2"><input type="text" class="inputTxt p100 acv" name="TE" id="TE"
                                               style="border:none; background: #bbc2cd; font-weight: bold;"/></th>
                        <th colspan="2"><input type="text" class="inputTxt p100 acv" name="TR" id="TR"
                                               style="border:none; background: #bbc2cd; font-weight: bold;"/></th>
                    </tr>
                    </tbody>
                </table>
