...
<head>
    ...
    <script type="text/javascript">
        ...
        //popupinit 함수는 주어진 object에 따라 팝업 창을 초기화하고 필드들을 설정합니다.
        // 이 함수는 주로 팝업 창을 열거나 수정하기 전에 필드 값을 설정하는 데 사용될 수 있습니다.
        ...
        //fn_selectone 함수는 주어진 no 값을 기반으로 서버에 Ajax 요청을 보내어 공지사항 정보를 조회하고, 조회된 데이터를 처리하여 팝업 창을 엽니다.
        // 이 함수는 주로 공지사항을 선택하여 상세 정보를 조회하고, 팝업 창을 열어 수정하거나 상세 내용을 확인하는 데 사용될 수 있습니다.
