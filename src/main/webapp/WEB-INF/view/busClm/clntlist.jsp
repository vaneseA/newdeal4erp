                ...
                <li class="contents">
                    ...
                    <div class="content">
                        ...
                        <div style="display:flex; justify-content:center; align-content:center; border:1px solid DeepSkyBlue; padding:40px 40px; margin-bottom: 8px;">
                            ...
                            <input type="text" style="width:300px; height:28px; margin-right:5px;" id="sname"
                                   name="sname">
            ...
            <dd class="content">
                ...
                <table class="row">
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="text" class="inputTxt p100" name="clnt_add_dt" id="clnt_add_dt"/>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">회사 이메일 <span class="font_red">*</span></th>
                        <td colspan="3"><input type="text" class="inputTxt p100" name="clnt_email" id="clnt_email"/>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">업종 <span class="font_red">*</span></th>
                        <td colspan="3"><input type="text" class="inputTxt p100" name="clnt_indst" id="clnt_indst"/>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">사업자등록번호 <span class="font_red">*</span></th>
                        <td colspan="3"><input type="text" class="inputTxt p100" name="clnt_indst_no"
                                               id="clnt_indst_no"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="radio" id="dtl_use_poa_1"
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" id="dtl_use_poa_2"
                                                            name="dtl_use_poa" value="N"/> <label
                                    for="radio1-2">미사용</label></td>
                    </tr>
                    </tbody>
                </table>
