...
<script type="text/javascript">
	...
	function popupinitfile(object) {
		...
		if (object == "" || object == null || object == undefined) {
			...
			$("#detail_name_modal").val(object.detail_name);
	...
	var filesavecallback = function(returnval) {
	 ...
	 callAjax("/empApm/updateApmStatus.do", "post", "json", true, param, filesavecallback);
				...
				<dd class="content">
					...
					<table class="row">
						...
						<tbody>
							...
							<td ><input type = "text" id = "vaca_sdate_modal" name="vaca_sdate_modal" style = "width: 130px; height:30px"></td>
							<th scope="row">지출날짜 </th>
							<td ><input type = "text" id = "vaca_edate_modal" name="vaca_edate_modal" style = "width: 130px; height:30px"></td>
						</tr>													
