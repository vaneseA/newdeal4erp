            ...
            <script type="text/javascript">
                ...
                function fn_approveSearch(pagenum) {
                    ...
                    var listcallback = function(returnvalue) {
                        ...
                        var paginationHtml = getPaginationHtml(pagenum, totalcnt, pageSize, pageBlockSize, 'fn_approveSearch');
        ...
        <body>
            <form id="myForm" action="" method="">
                <input type="hidden" id="action" name="action" />
                 ...
                 <input type="hidden" id="appro_type_cd" name="appro_type_cd" /> 
                 <input type="hidden" id="no" name="no" />
                  <input type="hidden" id="dept_name" name="dept_name" />
                   <input type="hidden" id="loginID" name="loginID" /> 
                   <input type="hidden" id="name" name="name" /> 
                   <input type="hidden" id="req_date" name="req_date" /> 
                   <input type="hidden" id="appro_yn" name="appro_yn" /> 
                   <input type="hidden" id="appro_date" name="appro_date" /> 
                   <input type="hidden" id="appro_bos" name="appro_bos" />
                   <input type="hidden" id="dept_name" name="dept_name" />
                        ...
                        <ul>
							...
							<div
								...
								<div>
									...
									<input type="date" id="from" name="from" style="width: 120px; height: 25px; font-size: 15px"> 
									<label for="to"> - </label> 
									<input type="date" id="to" name="to" style="width: 120px; height: 25px; font-size: 15px">       
									                                 
									<span class="label-font">&nbsp;&nbsp;&nbsp;&nbsp;결재여부: &nbsp;</span>
									 ...
									 <span class="label-font ">&nbsp;&nbsp;&nbsp;&nbsp;결재유형:&nbsp;</span> 
