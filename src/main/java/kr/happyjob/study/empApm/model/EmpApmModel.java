package kr.happyjob.study.empApm.model;

public class EmpApmModel {

    @Override
    public String toString() {
        return "EmpApmModel [loginID=" + loginID + ", name=" + name + ", level_cd=" + level_cd + ", dept_cd=" + dept_cd
                + ", detail_name=" + detail_name + ", splr_name=" + splr_name + ", product_name=" + product_name
                + ", pro_cd=" + pro_cd + ", product_unit_price=" + product_unit_price + ", dlv_amt=" + dlv_amt
                + ", date=" + date + ", dlv_no=" + dlv_no + ", product_no=" + product_no + ", splr_no=" + splr_no
                + ", appro_no=" + appro_no + ", appro_bos=" + appro_bos + ", appro_yn=" + appro_yn + ", dlv_rej_reason="
                + dlv_rej_reason + ", dlv_date=" + dlv_date + ", dlv_price=" + dlv_price + ", expen_price="
                + expen_price + ", appro_type_cd=" + appro_type_cd + ", appro_req_date=" + appro_req_date + ", vaca_no="
                + vaca_no + ", appro_date=" + appro_date + ", appro_price=" + appro_price + ", appro_rej_reason="
                + appro_rej_reason + ", vaca_sdate=" + vaca_sdate + ", vaca_edate=" + vaca_edate + ", vaca_reason="
                + vaca_reason + ", vaca_rej=" + vaca_rej + ", req_date=" + req_date + ", vaca_req_date=" + vaca_req_date + "]";
    }

    private String vaca_req_date;

    // Adding getter and setter for vaca_req_date
    ...
    public String getDlv_rej_reason() {
        return dlv_rej_reason;
    }

    public void setDlv_rej_reason(String dlv_rej_reason) {
        this.dlv_rej_reason = dlv_rej_reason;
    }
    ...
    public int getAppro_price() {
        return appro_price;
    }

    public void setAppro_price(int appro_price) {
        this.appro_price = appro_price;
    }
    ...
    private String dlv_rej_reason;
    private String dlv_date;
    private String dlv_price;
    ...
    public String getDlv_price() {
        return dlv_price;
    }

    public void setDlv_price(String dlv_price) {
        this.dlv_price = dlv_price;
    }
